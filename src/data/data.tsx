...
export const ProjectsList= [
  {
    ...
    technology: [<FaHtml5 className={`${size} bg-orange-600 h-10 w-10`}/>, <FaCss3 className={`${size} bg-blue-400`}/>, <FaPhp className={`${size} bg-violet-400`}/>, <SiMysql className={`${size} text-orange-600`}/>],
